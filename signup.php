...
?>
	<div class="container">
		<div class="div-box">
			...
			<form name="myForm" action="db_signup.php" method="post" onsubmit="return(validate());">
				<div class="card-body">
				...
				<div class="card-body">
					...
					<input type="password" class="form-control" id="pwd1" placeholder="Re-Enter password" name="repswd">
				</div>
